...
export const it = {
  ...
  shipping: {
    ...
    packaging: {
      ...
      categories: {
        title: "Categorie di imballo",
        help: "Quanto ti costa ogni tipo di imballo. Il costo si somma a ogni ordine che lo usa, così il profitto tiene conto anche di buste e scatole.",
        add: "Aggiungi categoria",
        empty: "Nessuna categoria ancora. Aggiungi le buste e le scatole che usi per spedire.",
        name: "Nome",
        cost: "Costo",
        origin: "Origine",
        actions: "Azioni",
        originShopify: "Da Shopify",
        originManual: "Creata da te",
        edit: "Modifica",
        delete: "Elimina",
        editLabel: (name: string) => `Modifica la categoria ${name}`,
        deleteLabel: (name: string) => `Elimina la categoria ${name}`,
        addTitle: "Nuova categoria di imballo",
        editTitle: (name: string) => `Modifica "${name}"`,
        nameHelp: "Ad esempio: Busta, Scatola piccola, Scatola grande.",
        costHelp: "Quanto ti costa un imballo di questo tipo.",
        deleteTitle: (name: string) => `Eliminare "${name}"?`,
        deleteBody: "Gli ordini che la usavano verranno ricalcolati senza il suo costo.",
        saved: "Categoria salvata",
        deleted: "Categoria eliminata",
      },
      rules: {
        title: "Regole per peso",
        help: "Quale imballo usare in base al peso dell'ordine. Si applica la prima regola che combacia, dall'alto in basso.",
        add: "Aggiungi regola",
        empty: "Nessuna regola ancora.",
        needsCategory: "Aggiungi prima una categoria di imballo.",
        weight: "Peso dell'ordine",
        category: "Categoria",
        actions: "Azioni",
        upTo: (kg: string) => `Fino a ${kg} kg`,
        edit: "Modifica",
        delete: "Elimina",
        editLabel: (rule: string, category: string) => `Modifica la regola ${rule}: ${category}`,
        deleteLabel: (rule: string, category: string) => `Elimina la regola ${rule}: ${category}`,
        addTitle: "Nuova regola per peso",
        editTitle: "Modifica regola",
        unlimitedLabel: "Tutto il resto",
        unlimitedHelp: "Vale per gli ordini più pesanti di tutte le altre regole.",
        deleteTitle: "Eliminare questa regola?",
        deleteBody: (rule: string, category: string) =>
          `${rule}: ${category}. Gli ordini che la usavano verranno ricalcolati con le regole rimaste.`,
        saved: "Regola salvata",
        deleted: "Regola eliminata",
      },
      defaults: {
        title: "Peso di default e resi",
      },
      cancel: "Annulla",
      ...
      errors: {
        ...
        categoryNotFound: "Questa categoria non c'è più: ricarica la pagina per vedere quelle attuali.",
        ruleNotFound: "Questa regola non c'è più: ricarica la pagina per vedere quelle attuali.",
        invalidDefaultWeight: "Inserisci un peso valido, pari o superiore a 0",
        invalidReturnCost: "Inserisci un costo di rientro valido, pari o superiore a 0",
