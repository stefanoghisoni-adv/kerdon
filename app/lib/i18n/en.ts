  ...
  shipping: {
    ...
    packaging: {
      ...
      categories: {
        ...
        help: "What each type of packaging costs you. The cost is added to every order that uses it, so your profit accounts for envelopes and boxes too.",
        add: "Add category",
        empty: "No categories yet. Add the envelopes and boxes you ship with.",
        name: "Name",
        cost: "Cost",
        origin: "Source",
        actions: "Actions",
        originShopify: "From Shopify",
        originManual: "Created by you",
        edit: "Edit",
        delete: "Delete",
        editLabel: (name: string) => `Edit the ${name} category`,
        deleteLabel: (name: string) => `Delete the ${name} category`,
        addTitle: "New packaging category",
        editTitle: (name: string) => `Edit "${name}"`,
        nameHelp: "For example: Envelope, Small box, Large box.",
        costHelp: "What one package of this type costs you.",
        deleteTitle: (name: string) => `Delete "${name}"?`,
        deleteBody: "Orders that used it will be recalculated without its cost.",
        saved: "Category saved",
        deleted: "Category deleted",
      },
      rules: {
        title: "Weight rules",
        help: "Which packaging to use based on the order's weight. The first matching rule applies, from top to bottom.",
        add: "Add rule",
        empty: "No rules yet.",
        needsCategory: "Add a packaging category first.",
        weight: "Order weight",
        category: "Category",
        actions: "Actions",
        upTo: (kg: string) => `Up to ${kg} kg`,
        edit: "Edit",
        delete: "Delete",
        editLabel: (rule: string, category: string) => `Edit the rule ${rule}: ${category}`,
        deleteLabel: (rule: string, category: string) => `Delete the rule ${rule}: ${category}`,
        addTitle: "New weight rule",
        editTitle: "Edit rule",
        unlimitedLabel: "Everything else",
        unlimitedHelp: "Applies to orders heavier than every other rule.",
        deleteTitle: "Delete this rule?",
        deleteBody: (rule: string, category: string) =>
          `${rule}: ${category}. Orders that used it will be recalculated with the remaining rules.`,
        saved: "Rule saved",
        deleted: "Rule deleted",
      },
      defaults: {
        title: "Default weight and returns",
      },
      cancel: "Cancel",
      ...
      errors: {
        ...
        categoryNotFound: "This category no longer exists: reload the page to see the current ones.",
        ruleNotFound: "This rule no longer exists: reload the page to see the current ones.",
        invalidDefaultWeight: "Enter a valid weight, 0 or more",
        invalidReturnCost: "Enter a valid return cost, 0 or more",
