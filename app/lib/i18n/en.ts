...
export const en: typeof it = {
  ...
  errors: {
    ...
    deleteConnected: 'This is the connected database: disconnect it first to delete it.',
  ...
  sync: {
    ...
    feed: {
      title: 'Feed address',
      description: 'Paste this address into Meta: it will read the catalogue on its own, every day.',
      format: 'Format',
      formatXml: 'XML',
      formatCsv: 'CSV',
      formatHelp: 'Meta reads both. Choose CSV if you would rather open it in a spreadsheet.',
      copy: 'Copy',
      copied: 'Copied',
      open: 'Open the file',
    ...
    steps: {
      ...
      one: 'Open Commerce Manager and pick your catalogue (or create an e-commerce one).',
    ...
    table: {
      ...
      summary: (included: number, total: number) => `${included} of ${total} products make it into the feed`,
